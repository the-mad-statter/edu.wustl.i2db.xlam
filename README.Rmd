...
# `r params$package` <img src="`r params$img_dir`/`r params$package`.png" align="right" width="125px" />

<!-- badges: start -->
`r badger::badge_github_release(paste(params$github, params$package, sep = "/"))`
`r badger::badge_last_commit(paste(params$github, params$package, sep = "/"), "main")`
<!-- badges: end -->
  
## Overview

This repository contains a Microsoft Excel add-in which provides a custom ribbon and additional functions for the [Institute for Informatics, Data Science & Biostatistics](https://i2db.wustl.edu/).
...
You should now have a custom ribbon and additional functions which all start with I2DB (e.g., I2DB_HMACSHA265()).

<br />

## Usage

Documentation is available [here](https://the-mad-statter.github.io/edu.wustl.i2db.xlam)
